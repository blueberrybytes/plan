...
This project is indexed by GitNexus as **plan** (7140 symbols, 17401 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
