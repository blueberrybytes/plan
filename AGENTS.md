...
This project is indexed by GitNexus as **plan** (7394 symbols, 18006 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
