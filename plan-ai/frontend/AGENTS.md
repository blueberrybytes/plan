...
This project is indexed by GitNexus as **plan-frontend** (2214 symbols, 4476 relationships, 135 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
