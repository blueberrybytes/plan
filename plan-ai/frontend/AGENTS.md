...
This project is indexed by GitNexus as **plan-frontend** (2353 symbols, 4918 relationships, 184 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
