...
This project is indexed by GitNexus as **plan-backend** (3018 symbols, 9485 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
