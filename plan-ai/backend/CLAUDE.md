...
This project is indexed by GitNexus as **plan-backend** (2859 symbols, 9024 relationships, 231 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
