...
- GANTT: Use 'gantt'. Begin with 'dateFormat YYYY-MM-DD' and a readable 'axisFormat' (e.g. '%b %Y'). Group tasks under 2–5 'section' headings, ~4–6 items each. Point-in-time events (hitos) MUST be milestones — write 'Nombre :milestone, 2026-03-01, 0d'. NEVER give a task an identical start and end date (e.g. ':done, 2026-06-05, 2026-06-05'): that is a zero-width, invisible bar. Real work gets a BOUNDED duration ('2w', '5d'); never let one task span the whole timeline (it dwarfs everything else). Prefer 'after <taskId>' to sequence work so bars and labels don't overlap. Mark finished work 'done', current work 'active', blockers 'crit'. Example: 'Diseño :done, 2026-01-05, 2w' and 'Lanzamiento :milestone, 2026-03-01, 0d'.
- MINDMAP: Use 'mindmap'.
