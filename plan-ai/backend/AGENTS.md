...
This project is indexed by GitNexus as **plan-backend** (2821 symbols, 8924 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
