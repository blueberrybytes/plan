...
export interface paths {
    ...
    "/api/projects/{projectId}/digest": {
        ...
        put?: never;
        /**
         * @description Generate (or regenerate) the Project Digest: a living synthesis of ALL the
         ...
         *     DocDocument, themed with the project's theme). Confidential meetings are
         *     excluded. The resulting doc id is stored on Project.metadata.digestDocId.
         */
        post: operations["GenerateProjectDigest"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CreateTranscriptRequest: {
            ...
            taskCount?: number;
            agenticInvestigation?: boolean;
            /** @description Meeting-type playbook outputs: generate a doc / slide deck from this meeting. */
            createDoc?: boolean;
            createSlides?: boolean;
        };
        BrandThemeSummary: {
        ...
        CreateDocInput: {
            ...
            themeId?: string;
            isBlank?: boolean;
            /** @description Link the doc to a specific project (for digest, auto-generated docs, etc.). */
            projectId?: string;
        };
        UpdateDocInput: {
            title?: string;
    ...
    GenerateProjectDigest: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ApiResponse__digestDocId-string--title-string__"];
                };
            };
        };
    };
