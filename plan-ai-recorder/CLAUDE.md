...
This project is indexed by GitNexus as **plan-recorder** (709 symbols, 1639 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
