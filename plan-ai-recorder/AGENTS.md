...
This project is indexed by GitNexus as **plan-recorder** (711 symbols, 1644 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/plan-recorder/context` | Codebase overview, check index freshness |
| `gitnexus://repo/plan-recorder/clusters` | All functional areas |
| `gitnexus://repo/plan-recorder/processes` | All execution flows |
| `gitnexus://repo/plan-recorder/process/{name}` | Step-by-step execution trace |
